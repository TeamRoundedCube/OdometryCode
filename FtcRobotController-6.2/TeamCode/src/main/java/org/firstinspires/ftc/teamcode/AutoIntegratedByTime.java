...
@Autonomous(name="AutoByTime", group="FullBot")

public class AutoIntegratedByTime extends LinearOpMode {
...
*/
    ...
    public int findRingCount() {
        ...
        telemetry.addData("inside ring Cont",tfod);
        telemetry.update();
        sleep(1000);
        if (tfod != null) {
            tfod.activate(); //if tensor flow is not equal to null it activates
            telemetry.addData("Inside tfod not null",tfod);
            telemetry.update();
            sleep(1000);
        }
        //runtime.reset();
    ...
    void goToDestination_C1(String startPosition) {
        ...
        //driveForward(DRIVE_SPEED, .65f * TILE);
//        sleep(500);
        slideLeft(1.0f * TILE);
        //dropOffWobbleGoal();
        //slideRight(.5f * TILE);
    ...
    void goToDestination_A1(String startPosition) {
        ...
        //dropOffWobbleGoal();
        // driveForward(DRIVE_SPEED, 2.5 * TILE);
        // slideLeft(2.0f * TILE);
